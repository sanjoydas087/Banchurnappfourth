...
with tab1:
    ...
    # # Keep bars narrow and separated even when geography filters change
    # fig3.update_traces(
    #     width=0.28,
    ...
    # )
        ...
        # Keep categorical bars narrow and consistent across the dashboard.
    # This prevents bars from becoming excessively wide when filters
